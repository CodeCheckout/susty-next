        ...
        {productDetails && <>
            <div className="bg-white">
                <div className="max-w-2xl mx-auto py-8 px-4 sm:py-12 sm:px-6 lg:max-w-7xl lg:px-8">
                    <Breadcrumb
                        pagePathArray={[productDetails.mainCategory, productDetails.subCategory1, productDetails.subCategory2]}/>
                    <div className="lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-start">
                        <ProductCarousel productImageArray={productDetails.images}/>
                        <SingleProductDetails sellerDetails={sellerDetails} productDetails={productDetails}/>
                    </div>
                </div>
            </div>
