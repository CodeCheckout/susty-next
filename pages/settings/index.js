...
const navigation = [
    ...
    {name: 'Account', href: '/settings/account/home', component: <AccountHome/>, current: false},
    {name: 'Shipping', href: '#', component: <ShippingHome/>, current: false},
    {name: 'Select discount', href: '#', component: < SelectDiscountHome/>, current: false},
    {name: 'Notifications', href: '#', component: <NotificationHome/>, current: false},
    {name: 'Privacy Settings', href: '#', component: <PrivacySettingsHome/>, current: false},
]
