                    ...
                    {messages.map((msg) => (
                        ...
                        >
                            <div className={"shrink-0"}>
                                <img
                                    className={"basis-1/4 sm:basis-1/6 md:basis-1/12 inline-block h-14 w-14 rounded-full"}
                                    src={msg.src}
                                    alt={msg.alt}
                                />
                            </div>
                            <div className={"basis-1/2 sm:basis-4/6 md:basis-9/12 pl-3 flex flex-col pr-2 w-full "}>
