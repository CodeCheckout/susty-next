            ...
            <div className="py-4 px-4 md:max-w-4xl mx-auto pt-8">
                <div className={'bg-white px-2 lg:px-2 shadow-sm'}>
                    <div className={'flex flex-col'}>
                        {receiverMessage.map((receive) => (
                            ...
                            >
                                ...
                                >
                                    <div
                                        className={
                                            'mx-auto lg:mx-0 text-susty text-base'
                                        }
                                    >
                                        {receiverUsername}
                                    </div>
                                    <HiInformationCircle
                                        className={
                                            'col-start-4 lg:col-start-6 ml-auto w-5 h5'
                                        }
                                    />
                                </div>
                        ...
                        <div
                            className={
                                'grid grid-cols-5 sm:grid-cols-12 lg:grid-cols-10 gap-2 px-2 sm:px-5 items-center border-t-2 border-gray-100 relative'
                            }
                        >
                            <FiCamera
                                className={
