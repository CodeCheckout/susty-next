        ...
        <div className={'grid place-content-center h-[75vh] bg-gray-50'}>
            <div className={"flex flex-col max-w-max bg-white p-3 shadow-md"}>
                <div className={"flex flex-col gap-2 font-medium p-4"}>
                    ...
                    <div className={"text-sm text-gray-500"}>Please enter the 4-digit code sent to:</div>
                ...
                <div className={"p-4"}>
                    <input type={"text"} onChange={(e) => {
                        setInputVerifyCode(e.target.value)
                           ...
                           className={"w-full px-4 py-1.5 text-sm rounded-md shadow-sm border border-gray-300 focus:border-susty focus:ring-susty focus:ring-offset-susty"}
                ...
                <div className={"flex flex-col text-xs font-medium"}>
                    ...
                    <div className={"mx-auto p-3"}>Having trouble? <Link href={"/helpcenter"}><a
                        className={"text-susty hover:underline"}>Get help</a></Link></div>
                </div>
            </div>
        </div>
    );
