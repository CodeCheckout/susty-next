                                    ...
                                    {isRegisterStatus === true ? <>
                                        {isRegisterAnd3Button === true ? <>
                                                <p className={"flex flex-col gap-3 text-3xl font-medium mt-5 pt-2"}>
                                                    <span className={"mx-auto"}>Join and sell pre-loved</span>
                                                    <span className={"mx-auto"}>clothes with no fees</span>
                                                </p>
                                            </> :
                                            <>
                                        ...
                                        {isRegisterAnd3Button === true ? <>
                                            <div
                                                ...
                                                <button aria-label="Continue with facebook" role="button"
                                                    ...
                                                    <p className="text-lg font-medium ml-4 text-gray-700">Continue with
                                                        Facebook</p>
                                                </button>
                                                <button
                                    ...
                                    {isRegisterStatus === true ? <>
                                        {isRegisterAnd3Button === true ? <>
                                            <div className={"flex flex-col gap-2"}>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Or
                                                    register
                                                    with <span onClick={() => {
                                                        setIsRegisterAnd3Button(false)
                                                    }}
                                                               className={"text-susty hover:underline cursor-pointer"}>Email</span>
                                                </div>
                                                <div
                                                    className={"text-lg text-gray-500 font-medium mx-auto cursor-pointer"}>Already
                                                    have an account? <span onClick={() => {
                                                        setIsRegisterStatus(false)
                                                    }} className={"text-susty hover:underline"}>Log in</span>
                                                </div>
                                            </div>
                                        </> : <>
                                            <div className="mt-6">
                                            ...
                                            <div className={"flex flex-col gap-2"}>
                                                <div
                                                    className={"text-sm font-medium text-gray-500"}>By
                                                    registering,
                                                    I confirm that I accept Susty's
                                                    <Link href={"/"}>
                                                        <span className={"text-susty hover:underline"}>
                                                            Terms and Conditions ,
                                                        </span>
                                                    </Link>
                                                    have read the <Link
                                                        href={"/"}>
                                                        <a className={"text-susty hover:underline"}>Privacy
                                                            Policy,</a></Link> and am at least 18 years old.
                                                </div>
                                                <div
                                        ...
                                        {isLoginRouteAnd3Button === true ? <>
                                            <div className={"flex flex-col gap-2"}>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Or log
                                                    in
                                                    with <span onClick={() => {
                                                        setIsLoginRouteAnd3Button(false);
                                                        setIsLoginEmailPassword(true);
                                                    }}
                                                               className={"text-susty hover:underline cursor-pointer"}>Email</span>
                                                </div>
                                                <div className={"text-lg text-gray-500 font-medium mx-auto"}>Don't
                                                    have
                                                    an account yet? <span onClick={() => {
                                                        setIsRegisterStatus(true);
                                                        setIsRegisterAnd3Button(true);
                                                    }}
                                                                          className={"text-susty hover:underline cursor-pointer"}>Sign up</span>
                                                </div>
                                            </div>
                                        </> : <>
                                            {isLoginEmailPassword === true ? <>
                                                ...
                                                <div className={"flex flex-col gap-2 mt-3"}>
                                                    <div onClick={() => {
                                                        setIsLoginEmailPassword(false);
                                                         ...
                                                         className={"text-lg font-medium mx-auto text-susty hover:underline cursor-pointer"}>Forgotten
                                                        your password?
                                                    </div>
                                                    <div
                                                        className={"text-lg font-medium mx-auto text-susty hover:underline cursor-pointer"}>Having
                                                        trouble?
                                                    </div>
                                                </div>
                                            </> : <>
