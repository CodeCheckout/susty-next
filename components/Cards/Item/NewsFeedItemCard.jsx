        ...
        <>
            <div className={"box-content w-[10.5rem] sm:w-[18rem] md:w-[13.5rem] lg:w-[14.5rem] min-h-max"}>
                <div className={"flex flex-col gap-2"}>
                    ...
                    <img
                        className={"h-[16.5rem] sm:h-[18rem] md:h-[22rem] lg:h-[22rem] w-[10.5rem] sm:w-[18rem] md:w-[13.5rem] lg:w-[14.5rem] object-cover"}
                        src={src} alt={alt}
                ...
                <div className={"p-3 grid grid-cols-3"}>
                    <div className={"col-start-1 col-end-3"}>
                        <div className={"flex flex-col gap-0.5"}>
                            <div className={"flex flex-row gap-1"}>
                                ...
                                <HiInformationCircle className={"w-[1.25rem] h-[1.25rem] text-gray-500 text-sm"}/>
                            </div>
                    ...
                    <div className={"col-start-3 col-end-4"}>
                        <div className={"flex flex-row justify-end items-center gap-0.5 text-gray-400"}>
                            {isFavourite === true ? <>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-900"
