                ...
                <div className="sm:flex sm:items-center">
                    <div className="sm:flex-auto">
                        ...
                        <p className="mt-2 text-sm text-gray-700">
                            A list of all Received Orders. Make sure to send the order!
                        </p>
                    </div>
                </div>
                                        ...
                                        >
                                            <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <div
                                                            className="text-sm font-medium text-gray-900">{item.orderId.length > 20 ? item.orderId.slice(0, 20) + '...' : item.orderId}</div>
                                                        <div
                                                            className="text-xs text-gray-500">{item.buyerId.length > 20 ? item.buyerId.slice(0, 20) + '...' : item.buyerId}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <div
                                                            className="inline-flex mr-3 text-sm font-medium text-gray-900">{item.product}</div>
                                                        <div
                                                            className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-200 text-gray-500">{item.amount}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
