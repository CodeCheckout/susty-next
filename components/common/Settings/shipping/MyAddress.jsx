...
import {HiBookmarkAlt, HiCheck, HiChevronRight, HiInformationCircle, HiSelector} from 'react-icons/hi'
        ...
        <div className="w-full ">
            <div className="w-full bg-white">
                ...
                <div className={"flex flex-row items-center justify-between px-4 py-3 hover:bg-gray-50"}>
                    ...
                    <HiChevronRight className={"w-5 h-5"} onClick={() => setOpenAddressModal(true)}/>
                </div>
                <>
                    <AnimatePresence>
                        {openAddressModal && (
                                        ...
                                        <motion.div
                                            ...
                                            <div className={"w-72 sm:w-96 border border-gray-200 p-3"}>
                                                <div className={"flex flex-row gap-2 "}>
                                                    <HiInformationCircle className={"text-susty w-10 h-10"}/>
                                                    <p className={"text-sm"}>Your ZIP Code is used to calculate
                                                        applicable sales tax. <Link href={"#"}><a
                                                            className={"text-susty hover:underline"}>Learn
                                                            more.</a></Link></p>
                                                </div>
                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        ...
                                                        <Listbox value={selectedCountry.flag}
                                                            ...
                                                            {({open}) => (<>
                                                                <div
                                                                    className="py-1 relative pl-4 bg-white overflow-hidden">
                                                                    <Listbox.Button
                                    ...
                                    <span
                                        ...
                                        <HiSelector className="h-5 w-5 text-gray-400" aria-hidden="true"/>
                                                ...
                                                <div className={"max-w-full"}>
                                                    ...
                                                    <div>
                                                        <input type={"text"} onChange={(e) => {
                                                            setInputAddressLine2(e.target.value)
