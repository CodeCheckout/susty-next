    ...
    return (
        <div className={'block'}>
            <div>
                ...
                <div className={"px-3 mt-3 mb-6 text-xs text-gray-500"}>You can give discounts in ascending order,
                    starting with any number of items. <br></br> The better the deal, the more you'll sell! For
                    help, see the FAQ.
                </div>
            </div>
                                ...
                                <div className={`grid place-items-center`}>
                                    <div className='w-full pr-3'>
                                        <Menu as="div" className="relative inline-block text-left w-full">
                                            ...
                                            >
                                                <Menu.Items
                                                    className="z-10 origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
