...
const sellingDetails = [
    {
        ...
        content: 'Download the Susty app for free. Take photos of your item, describe it, and set your price. Tap “Upload” and your listing is live.'
    },
    {
        id: 2,
        ...
        content: 'Sold! Box your item, print your prepaid shipping label, and pop to the drop-off point within 5 days.'
    },
    {
        id: 3,
        topic: 'It’s payday!',
        ...
        content: 'There are zero selling fees, so what you earn is yours to keep. You’ll be paid as soon as the buyer confirms everything’s OK.'
    },
];
...
const SellingIsSimpleSection = () => {
    ...
    return (
        <BasicPageWrapper>
            <div className={`py-10 text-gray-900 text-3xl sm:text-4xl font-semibold`}>Selling is simple</div>
