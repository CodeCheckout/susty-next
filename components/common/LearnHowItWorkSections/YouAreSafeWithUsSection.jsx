...
const descriptionDetails = [
    ...
    },
    {
        ...
        content:
            'Your order is protected when you pay through Susty. You’ll get a refund if your item doesn’t arrive, was damaged in transit, or is significantly not as described. Let us know within 2 days of delivery if something isn’t right. Unless otherwise agreed, the buyer covers the return cost.\n',
    },
]
            ...
            <div className={`flex flex-col lg:flex-row gap-3 items-start`}>
                {descriptionDetails.map((detail) => {
                    return (
                        ...
                        >
                            <div
                                className={`p-4 bg-red-50 rounded-full border border-susty`}
                            >
                                {detail.icon}
                            </div>
                            <div className={`flex flex-col gap-3`}>
                                ...
                                <div className={`pb-5`}>
                                    <Link href={`/helpcenter`}>
                                        <a
                                            className={`text-susty hover:underline`}
                                        >
                                            Learn more
                                        </a>
                                    </Link>
