...
const imageStaticList = [
    ...
    },
    {
        ...
        description:
            'When they list 3 items within 7 days of joining, you’ll get a $5 voucher. You’ll get an extra $10 voucher if they complete a sale within 30 days.',
    },
    {
        id: 3,
        ...
        description:
            'Buy an item that costs $15 or more (not including shipping), and your voucher will be automatically deducted from the item price.',
    },
]

const mobileImg =
    'https://5a2583d7dd16c25cb2e8-358d15e499fca729302e63598be13736.ssl.cf3.rackcdn.com/referrals/how_it_works_icon.png'
        ...
        <BasicPageWrapper>
            <div className={'hidden md:block mt-10'}>
                <div className={'grid grid-rows-6 gap-1 px-8'}>
                    <div className={'row-span-1 text-3xl font-medium'}>
                        How referrals work
                    </div>
                            ...
                            <div key={image.id}>
                                <div className={'col-span-1 my-5'}>
                                    <img
                                        src={image.src}
                                        alt={image.alt}
                                        className={'object-cover box-content'}
                                        width={'300'}
                                        height={'300'}
                                    />
                                    <div
                    ...
                    <div className={'row-span-1 text-xs text-gray-500'}>
                        ...
                        The people you refer need to consent to receiving your
                        referral invite. To receive your voucher, your friend
                        must list 3 items within 7 days. If your friend sells an
                        item within 30 days, you’ll receive an additional
                        voucher. To learn more,
                        <Link href={'/'}>
                            <a className={'text-susty hover:underline'}>
                                {' '}
                                visit the FAQ.
            ...
            <div className={'block md:hidden'}>
                <div
                    className={
                        'grid grid-cols-6 gap-4 items-center py-2 my-2 mx-1 px-5'
                    }
                >
                    ...
                    <div className={'col-span-1 ml-auto'}>
                        <HiChevronRight
                            className={'w-5 h-5'}
                            onClick={() => setOpenReferralsModal(true)}
                        />
                    </div>
                    <>
                        <AnimatePresence>
                            {openReferralsModal && (
                                ...
                                >
                                    <div className="fixed inset-0 overflow-y-auto font-susty">
                                        <div className="flex min-h-max items-center justify-center p-4 text-center bg-gray-700 bg-opacity-80">
                                            <motion.div
                                                key={`modal-for-email`}
                                                initial={{
                                                    scale: 0.8,
                                                        ...
                                                        <div key={image.id}>
                                                            ...
                                                            >
                                                                <img
                                                                    ...
                                                                    className={
                                                                        'mx-auto object-cover box-content'
                                                                    }
                                                                    width={
                                                                        '200'
                                                                    }
