...
const InviteCard = () => {
    ...
    const [referralLink, setReferralLink] = useState("https://susty-next.vercel.app");
    ...
    return (
        <div style={{
            ...
            <div className={"grid font-susty justify-start px-4 sm:pl-20 lg:pl-36 pt-20"}>
                <div className='max-w-max sm:w-96 bg-gray-50 p-6'>
                    <h1 className='font-bold justify-items-center text-2xl'>Invite friends and earn up to
                        ${price} </h1>
                        ...
                        <li className="group grid grid-cols-12">
                            ...
                            <div className='col-span-1 justify-items-end'>
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none"
                                     viewBox="0 0 24 24" stroke="#7d7d7d" strokeWidth="2">
                                    ...
                                    <motion.div
                                        ...
                                        >
                                            <p className="text-lg font-medium leading-5 text-gray-500 flex justify-between">
                                                Your referrals
                                                <span
                                                    onClick={() => setEnableReferrals(false)}
                                        ...
                                        <div className='grid place-content-center'>
                                            <img
                                                ...
                                                alt="Image_content__lvAec" width="120px" height="120px"/>
                                        </div>
                                        <div className='grid place-content-center'>
                                            <p className='text-2xl pt-6'>No friends have joined yet</p>
                                        </div>
                                        <div className='grid place-content-center'>
                                            <p className='py-6'>Earn up to $15.00 to spend on Susty — share your
                                                invite link with friends</p>
                                        </div>
