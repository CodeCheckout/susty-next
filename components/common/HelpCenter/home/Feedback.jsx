                                ...
                                >
                                    ...
                                    <div className="mt-2 flex flex-col gap-2">
                                        <p className="text-sm text-gray-500 leading-relaxed">
                                            ...
                                            think about Susty. Do you love a
                                            particular feature, or have you got
                                            an idea of how we can make your
                                            experience better?
                                        </p>
                                        <p className="text-sm text-gray-500 leading-relaxed">
                                            Your insight can help us bring to
                                            life the improvements that you need
                                            the most, so don’t hesitate and
                                            share your thoughts. We value every
                                            opinion we get!
                                        </p>
                                    </div>
