...
const PurchaseHistoryWrapper = ({arrayElements, sidebarOpen, sidebarElement, selectedItem, setSidebarOpen,
                                    setSidebarElement, setSelectedItem, pageTitle,
                                }) => {
    return (
                            ...
                            <div className="flex-1 flex flex-col min-h-full">
                                <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto ">
                                    <div className="flex items-center flex-shrink-0 px-4">
                                        <p className="font-semibold text-2xl">Purchase History</p>
                                    </div>
...
export default PurchaseHistoryWrapper;