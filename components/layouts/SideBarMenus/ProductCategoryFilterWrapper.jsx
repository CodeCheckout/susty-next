...
import {HiBookmarkAlt, HiChevronDown, HiFilter, HiMinusSm, HiPlusSm, HiViewGrid, HiHome} from 'react-icons/hi'
...
const ProductCategoryFilterWrapper = ({children, topic, noOfItems, pagePath, productResult, setProductResult}) => {
    ...
    useEffect( () => {
        ...
        await axios.get('/api/product/filter-products', {params: data})
                ...
                <main className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    ...
                    <section aria-labelledby="products-heading" className="pt-6 pb-10">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
                            {/* Filters */}
                            <form
                                className="hidden lg:block min-w-max sticky top-0 h-[60vh] overflow-y-auto pr-5 mt-5">
                                <h3 className="sr-only">Categories</h3>
                                <ul role="list"
