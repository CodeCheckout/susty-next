        ...
        <div className={'py-[2rem]'}>
            <div className={'flex flex-col gap-3'}>
                <div className={'flex flex-row justify-between items-center py-5'}>
                    ...
                    <div className={'px-2.5 py-1 mr-10 text-sm text-susty hover:bg-red-50'}><Link href="#"><a>See
                        more</a></Link></div>
                </div>
                <div className={'flex flex-row justify-between items-center py-5 mr-4'}>
                    <div>
                        {person.map((personD) => (
                            <div key={personD.id} className={'flex flex-row gap-2'}>
                                <img src={personD.profileImg} alt={personD.profileAlt}
            ...
            <div
                ...
                {children}
                <div
                    className={"min-w-max lg:w-[12.5rem] h-[18rem] px-8 my-3 lg:my-0 bg-gray-200 inline-flex items-center place-content-center"}>
