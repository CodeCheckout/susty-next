                                ...
                                <div className="mt-1 relative w-full">
                                    <Listbox.Button
                                        className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-0 focus:ring-susty focus:border-susty sm:text-sm">
                                               <span className="w-full inline-flex truncate">
                                                   <span className="truncate">{categoryOne}</span>
                                               </span>
                                        <span
                                    ...
                                    >
                                        <Listbox.Options
                                            ...
                                            {categoryFirst.map((catOne, index) => (
                                                <div
                                                    key={index}
                                                >
                                                    <div>
                                                        ...
                                                        >
                                                            {({categoryOne, active}) => (
                                                                <>
                                                                    <div className="grid">
                                                                        <div
                                                                            className={classNames(categoryOne ? 'font-semibold' : 'font-medium', 'antialiased')}>{catOne}</div>
                                                                    </div>
                            ...
                            <>
                                <div className="mt-1 relative w-full">
                                    <Listbox.Button
                                        className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-0 focus:ring-susty focus:border-susty sm:text-sm">
                                               <span className="w-full inline-flex truncate">
                                                   <span className="truncate">{categoryTwo}</span>
                                               </span>
                                        <span
                                            className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                                   <HiSelector className="h-5 w-5 text-gray-400" aria-hidden="true"/>
                                    ...
                                    >
                                        <Listbox.Options
                                            className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                                            {categorySecond.map((catTwo, index) => (
                                                <div key={index}>
                                                    <div>
                                                        <Listbox.Option
                                                            key={catTwo}
                                                        ...
                                                        >
                                                            {({categoryTwo, active}) => (
                                                                <>
                                                                    <div className="grid">
                                                                        <div
                                                                            className={classNames(categoryTwo ? 'font-semibold' : 'font-medium', 'antialiased')}>{catTwo}</div>
                                                                    </div>
                            ...
                            <>
                                <div className="mt-1 relative w-full">
                                    <Listbox.Button
                                        className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-0 focus:ring-susty focus:border-susty sm:text-sm">
                                               <span className="w-full inline-flex truncate">
                                                   <span className="truncate">{categoryThree}</span>
                                               </span>
                                        <span
                                            className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                                                   <HiSelector className="h-5 w-5 text-gray-400" aria-hidden="true"/>
                                    ...
                                    >
                                        <Listbox.Options
                                            className="absolute z-10 mt-1 w-full bg-white shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
                                            {categoryThird.map((catThree, index) => (
                                                <div key={index}>
                                                    <div>
                                                        <Listbox.Option
                                                            key={catThree}
                                                            ...
                                                            value={catThree}
                                                        >
                                                            {({categoryThree, active}) => (
                                                                <>
                                                                    <div className="grid">
                                                                        <div
                                                                            className={classNames(categoryThree ? 'font-semibold' : 'font-medium', 'antialiased')}>{catThree}</div>
                                                                    </div>
                                                        ...
                                                        >
                                                            {({sizenow, active}) => (
                                                                <>
                                                                    <div className="grid">
                                                                        <div
                                                                            className={classNames(sizenow ? 'font-semibold' : 'font-medium', 'antialiased')}>{catThree}</div>
                                                                    </div>
