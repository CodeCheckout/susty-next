export const categoryObj = [
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Women/Shoes/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "12e0237f-4d0c-42ec-8593-76ef2d2a45ab",
                        name: "Heels",
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Women/Bags/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
    ...
    {
        id: "96d6f546-8fc9-4064-86c2-c92f02a98217",
        name: "Men",
        subCategory: [
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Men/Grooming/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "4966d628-c08c-4c38-a09f-60551b46b93a",
                        name: "Tools & accessories",
                        href: "Men/Grooming/Tools & accessories".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "26ccb71a-4ae5-488a-84f4-a33ccbb6e4cc",
                        name: "Body care",
                        href: "Men/Grooming/Body care".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "4760eb39-1137-4163-ae82-9f9b8fe3a552",
                        name: "Aftershave & cologne",
                        href: "Men/Grooming/Aftershave & cologne".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "81d17332-09e7-4edb-b2da-5d586a858398",
                        name: "Grooming kits",
                        href: "Men/Grooming/Grooming kits".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "de591c57-bced-45af-b490-9dcffa145f52",
                        name: "Face care",
                        href: "Men/Grooming/Face care".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "ee5ef532-d3ad-42d3-b70e-03f628567a03",
                        name: "Hair care",
                        href: "Men/Grooming/Hair care".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "4f1d63f9-b839-4422-b954-e8d3c0135945",
                        name: "Hand & nail care",
                        href: "Men/Grooming/Hand & nail care".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "dad92182-39a5-4168-b70e-a44a81cfdf8f",
                        name: "Makeup",
                        href: "Men/Grooming/Makeup".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "c620e77c-0b32-42e5-8d8e-6b7d006466fa",
                        name: "Other grooming items",
                        href: "Men/Grooming/Other grooming items".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
        ]
    ...
    {
        id: "3dd3a3ad-a481-420c-84d3-c4ac42206298",
        name: "Kids",
        subCategory: [
            {
            ...
            },
            {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        name: "Shoes",
                        href: "Kids/Girls' clothing/Shoes".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "0d81f64c-37d9-42a7-9a99-6cab759a963e",
                        name: "Sweaters & hoodies",
                        href: "Kids/Girls' clothing/Sweaters & hoodies".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "9aeea8a6-19f8-4d59-b358-fcaba267c89f",
                        name: "Dresses",
                        href: "Kids/Girls' clothing/Dresses".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "29182c68-1318-4b1d-8ba5-d5cc891487f6",
                        name: "Pants & shorts",
                        href: "Kids/Girls' clothing/Pants & shorts".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "23430e20-d905-4422-b723-34a6f424ab70",
                        name: "Accessories",
                        href: "Kids/Girls' clothing/Accessories".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "d53a966b-93a8-410e-b888-13faca0815b2",
                        name: "Underwear & socks",
                        href: "Kids/Girls' clothing/Underwear & socks".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "e94f870c-a761-485f-833f-3761397760b5",
                        name: "Sportswear",
                        href: "Kids/Girls' clothing/Sportswear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "21c547fe-9d0e-4838-b81c-6df2fd574f1e",
                        name: "Clothing for twins",
                        href: "Kids/Girls' clothing/Clothing for twins".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "706989f1-78da-4bac-a6c7-d8838a92c9c6",
                        name: "Formal wear & special occasions",
                        href: "Kids/Girls' clothing/Formal wear & special occasions".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "74577092-7f7c-44ad-bb20-095242c60e34",
                        name: "Baby clothing",
                        href: "Kids/Girls' clothing/Baby clothing".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "b39f1478-ee4a-4be1-8d0a-807feccff816",
                        name: "Coats & jackets",
                        href: "Kids/Girls' clothing/Coats & jackets".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "65e85b9e-d1d7-471e-aadd-0a5478556be1",
                        name: "Tops & T-shirts",
                        href: "Kids/Girls' clothing/Tops & T-shirts".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "788eaec9-93ba-4ae7-8198-27ec77838da7",
                        name: "Skirts",
                        href: "Kids/Girls' clothing/Skirts".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "a0fd2762-70a2-429c-bbcd-551a0c795558",
                        name: "Bags & backpacks",
                        href: "Kids/Girls' clothing/Bags & backpacks".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "017bc1ee-cb11-46f3-b27b-4b2261826d12",
                        name: "Swimwear",
                        href: "Kids/Girls' clothing/Swimwear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "f6cdcc98-4871-4656-b37c-5f0ebc926362",
                        name: "Sleepwear",
                        href: "Kids/Girls' clothing/Sleepwear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "026fd68a-5fff-4e91-96f9-de4fb7609af4",
                        name: "Clothing bundles",
                        href: "Kids/Girls' clothing/Clothing bundles".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "920827ac-0886-40b7-83cd-6a23ca06de19",
                        name: "Fancy dress & costumes",
                        href: "Kids/Girls' clothing/Fancy dress & costumes".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "b09484e3-bc4d-48fd-8e86-1e4715496e49",
                        name: "Other girls' clothing",
                        href: "Kids/Girls' clothing/Other girls' clothing".split(' ').join('-').trim().toLowerCase()
                    },
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Kids/Boys' clothing/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "674bb10f-8517-46eb-87ee-548ea4950838",
                        name: "Shoes",
                        href: "Kids/Boys' clothing/Shoes".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "650a564e-a9be-470a-b99d-acbd5713b829",
                        name: "Sweaters & hoodies",
                        href: "Kids/Boys' clothing/Sweaters & hoodies".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "47a8730c-2cd6-4f45-bf04-64fa400c78cb",
                        name: "Pants & overalls",
                        href: "Kids/Boys' clothing/Pants & overalls".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "a824be04-dfd4-46c4-860b-66f794665d99",
                        name: "Accessories",
                        href: "Kids/Boys' clothing/Accessories".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "cbf8ccd2-3c81-4736-bdfa-826c19b20760",
                        name: "Underwear & socks",
                        href: "Kids/Boys' clothing/Underwear & socks".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "ffb20765-7d98-44b1-a9f7-dd21a02cafed",
                        name: "Sportswear",
                        href: "Kids/Boys' clothing/Sportswear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "a724126f-5da1-4852-bc01-21d8f46e20f1",
                        name: "Clothing for twins",
                        href: "Kids/Boys' clothing/Clothing for twins".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "03115913-18ce-4708-b377-98ebebbe780b",
                        name: "Formal wear & special occasions",
                        href: "Kids/Boys' clothing/Formal wear & special occasions".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "68f70bf7-8361-45e2-af01-7a1477476ef9",
                        name: "Baby clothing",
                        href: "Kids/Boys' clothing/Baby clothing".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "6b15becb-16c4-4d18-93d6-49096d61b349",
                        name: "Coats & jackets",
                        href: "Kids/Boys' clothing/Coats & jackets".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "3c017bba-269a-4bc3-a257-14e4d0d8b3ba",
                        name: "Tops & T-shirts",
                        href: "Kids/Boys' clothing/Tops & T-shirts".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "a3345ec1-5eb6-426c-8304-418088dc3fb9",
                        name: "Bags & backpacks",
                        href: "Kids/Boys' clothing/Bags & backpacks".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "10275fbe-b552-4fca-953c-1cea2964de99",
                        name: "Swimwear",
                        href: "Kids/Boys' clothing/Swimwear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "c03f6fdf-76cd-490c-babb-f2b918a5678d",
                        name: "Sleepwear",
                        href: "Kids/Boys' clothing/Sleepwear".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "55bf6b66-ebc1-45cc-8952-3b1a0431a8b4",
                        name: "Clothing bundles",
                        href: "Kids/Boys' clothing/Clothing bundles".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "47c127ac-6007-4723-98cc-86977b9d6110",
                        name: "Fancy dress & costumes",
                        href: "Kids/Boys' clothing/Fancy dress & costumes".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "84d0f461-8ab7-4f83-ae10-86a4bd9a8127",
                        name: "Other boys' clothing",
                        href: "Kids/Boys' clothing/Other boys' clothing".split(' ').join('-').trim().toLowerCase()
                    },
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Kids/Toys & games/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "e5a8a830-ed08-44a9-bf16-ac7350cd4681",
                        name: "Electronic games",
                        href: "Kids/Toys & games/Electronic games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "b2e0cd5e-2438-4a4c-9385-92194a2ebbe8",
                        name: "Educational toys",
                        href: "Kids/Toys & games/Educational toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "8276bd42-9f7e-479e-92ee-1fad38df757b",
                        name: "Musical toys",
                        href: "Kids/Toys & games/Musical toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "2c12500f-5729-4a01-86c3-eae92b247116",
                        name: "Wooden toys",
                        href: "Kids/Toys & games/Wooden toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "0fe3686a-2d01-42ad-8987-f9daadf3d427",
                        name: "Kitchen toys",
                        href: "Kids/Toys & games/Kitchen toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "3b41be2c-64f1-4e30-906e-5864c89481a6",
                        name: "Action figures",
                        href: "Kids/Toys & games/Action figures".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "95de39bc-119f-45cf-8c9f-fdf6602835be",
                        name: "Dolls",
                        href: "Kids/Toys & games/Dolls".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "82600559-316b-45dc-a887-dd7a0194cfce",
                        name: "Soft toys & stuffed animals",
                        href: "Kids/Toys & games/Soft toys & stuffed animals".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "90374152-9685-443e-ad7e-767fc6d4790b",
                        name: "Construction toys",
                        href: "Kids/Toys & games/Construction toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "47aae31b-ed66-4ac5-8055-b7940f467419",
                        name: "Outdoor toys",
                        href: "Kids/Toys & games/Outdoor toys".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "62a71985-60f4-46b8-a749-03ba28950633",
                        name: "Sleeping toys",
                        href: "Kids/Toys & games/Sleeping toys".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Kids/Baby care/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "6a87a073-b45c-46e2-8628-0fccd278b060",
                        name: "Nursing & feeding",
                        href: "Kids/Baby care/Nursing & feeding".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "60287571-2c97-4e50-9a3e-939d60db28bf",
                        name: "Childcare accessories & tech",
                        href: "Kids/Baby care/Childcare accessories & tech".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "cbc95dc0-1898-4d3d-85ec-759d8cf8f845",
                        name: "Potties",
                        href: "Kids/Baby care/Potties".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "fcd6fdb1-c7e9-4260-b1fb-2076008417ad",
                        name: "Sleep accessories",
                        href: "Kids/Baby care/Sleep accessories".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "1cbd513d-706f-41ed-8cea-4a9de50b83f7",
                        name: "Diapers & skincare",
                        href: "Kids/Baby care/Diapers & skincare".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "97f1ec80-2e6b-46c7-9cdd-0185defe5f7d",
                        name: "Bibs",
                        href: "Kids/Baby care/Bibs".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "60560160-741c-4154-b373-27598a036994",
                        name: "Childproofing & safety",
                        href: "Kids/Baby care/Childproofing & safety".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                sections: [
                    ...
                    {
                        id: "cc5fe2a7-a4d1-4289-9076-12cf888fa5cb",
                        name: "Changing pads & tables",
                        href: "Kids/Kids' furniture/Changing pads & tables".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Kids/School supplies/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "5f9db365-7f8a-4e37-8991-5ffeb70f1ee8",
                        name: "School supplies",
                        href: "Kids/School supplies/School supplies".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "892d5a98-4736-4a84-bd71-f5a4396c2b1d",
                        name: "School bags",
    ...
    {
        id: "28bed20b-713e-4277-9dc1-7af35f674615",
        name: "Home",
        subCategory: [
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Home/Textiles/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "29151ec5-f070-4862-ad79-5bdfcc642412",
                        name: "Blankets",
                        href: "Home/Textiles/Blankets".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "2087af66-a7b2-4c51-8dcc-ed702bdb414b",
                        name: "Throw pillows",
                        href: "Home/Textiles/Throw pillows".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "05f94c6d-c94d-4d4c-9ca5-027ee4c5946d",
                        name: "Table linen",
                        href: "Home/Textiles/Table linen".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "14df9408-3052-4d0b-b4a8-7f4bbd124284",
                        name: "Towels",
                        href: "Home/Textiles/Towels".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "27d23ad9-111c-4e90-b69a-8ef734f45575",
                        name: "Bedding",
                        href: "Home/Textiles/Bedding".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "edb62f40-82b0-4f99-83f8-b1ab8ffc2515",
                        name: "Curtains & drapes",
                        href: "Home/Textiles/Curtains & drapes".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "c24e907f-c497-48e6-ab81-580b6deeee55",
                        name: "Rugs & mats",
                        href: "Home/Textiles/Rugs & mats".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "e909ecc1-898e-4634-848c-3a56bcad43bb",
                        name: "Tapestries & wall hangings",
                        href: "Home/Textiles/Tapestries & wall hangings".split(' ').join('-').trim().toLowerCase()
                    },
                ]
            },
            {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        name: "Clocks",
                        href: "Home/Home accessories/Clocks".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "2fd86205-59a9-46c1-aab1-8b28d0a78b1d",
                        name: "Picture & photo frames",
                        href: "Home/Home accessories/Picture & photo frames".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "aef342a5-17bc-467f-ae9d-53b704e64043",
                        name: "Storage",
                        href: "Home/Home accessories/Storage".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "515efe99-6c0e-45ec-86ba-5c9bd297f43f",
                        name: "Candles & candle holders",
                        href: "Home/Home accessories/Candles & candle holders".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "490eb424-f450-4a48-a792-572533492298",
                        name: "Display shelves",
                        href: "Home/Home accessories/Display shelves".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "cf86aad9-d682-41af-9873-4bc474f36095",
                        name: "Mirrors",
                        href: "Home/Home accessories/Mirrors".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "34770de1-1f40-4ca0-989f-37fdb017797c",
                        name: "Vases",
                        href: "Home/Home accessories/Vases".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Home/Tableware/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "edff0833-d494-43ec-be92-d8f181da98ae",
                        name: "Dinnerware",
                        href: "Home/Tableware/Dinnerware".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "d450efd6-b088-4a64-9733-683dae49593b",
                        name: "Cutlery",
                        href: "Home/Tableware/Cutlery".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "5c9115ef-9b33-432b-8b92-897c5c464eca",
                        name: "Drinkware",
                        href: "Home/Tableware/Drinkware".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            }
        ]
    ...
    {
        id: "56fbf6d0-a0df-4eab-8dd5-77552b3e0c03",
        name: "Entertainment",
        subCategory: [
            {
            ...
            },
            {
                ...
                sections: [
                    ...
                    },
                    {
                        ...
                        name: "Xbox One",
                        href: "Entertainment/Video games & consoles/Xbox One".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "a4ac68ec-8253-4a82-920e-82eb69d37c8d",
                        name: "PlayStation 5",
                        href: "Entertainment/Video games & consoles/PlayStation 5".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "4dc1b9a3-6d0a-46b5-8199-5b83973bacdc",
                        name: "Older PlayStation",
                        href: "Entertainment/Video games & consoles/Older PlayStation".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "36fd28bb-03a7-4c89-a958-afe527e7603e",
                        name: "Nintendo Wii & Wii U",
                        href: "Entertainment/Video games & consoles/Nintendo Wii & Wii U".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "e4407aa3-e284-4e06-aa91-9509ba3bf127",
                        name: "Nintendo Game Boy",
                        href: "Entertainment/Video games & consoles/Nintendo Game Boy".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "9c93c392-9438-4456-9b3c-4f4365a860d0",
                        name: "Sega",
                        href: "Entertainment/Video games & consoles/Sega".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "b143d138-d7c4-458e-bba7-7b741fe757a8",
                        name: "Virtual reality",
                        href: "Entertainment/Video games & consoles/Virtual reality".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "2d4e4a77-0518-4142-a6e0-032c7c0d502c",
                        name: "Xbox Series X & S",
                        href: "Entertainment/Video games & consoles/Xbox Series X & S".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "db7e5517-66c3-4a71-b0be-1402cfc2f88e",
                        name: "Older Xbox",
                        href: "Entertainment/Video games & consoles/Older Xbox".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "776661dc-94c4-4d26-958c-eff1cabcf699",
                        name: "PlayStation 4",
                        href: "Entertainment/Video games & consoles/PlayStation 4".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "19700843-6d59-4fee-bd5e-aec7e607e6d7",
                        name: "Nintendo Switch",
                        href: "Entertainment/Video games & consoles/Nintendo Switch".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "0bea8a5e-bc89-4a61-9df2-d106e9564c40",
                        name: "Nintendo 3DS & 2DS",
                        href: "Entertainment/Video games & consoles/Nintendo 3DS & 2DS".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "574ef1c5-e205-49b3-aeba-301013ab33b4",
                        name: "Older Nintendo",
                        href: "Entertainment/Video games & consoles/Older Nintendo".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "ef7df814-1604-4550-9c74-7dc407639cad",
                        name: "PC games",
                        href: "Entertainment/Video games & consoles/PC games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "df1e5539-3f3d-4ce8-94d5-75766870760a",
                        name: "Retro gaming",
                        href: "Entertainment/Video games & consoles/Retro gaming".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        id: "All",
                        name: "4642422e-0e87-4a3a-8d7a-10b2a4de7f04",
                        href: "Entertainment/Games & puzzles/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "ba07f812-94c0-439e-91d6-479a7cd9a115",
                        name: "Tile-based games",
                        href: "Entertainment/Games & puzzles/Tile-based games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "d92a8862-57a3-4d75-bd1e-f8172d7973c7",
                        name: "Jigsaws",
                        href: "Entertainment/Games & puzzles/Jigsaws".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "4ae8ae5e-3aa9-4b34-b2fa-8398b6ddd1a0",
                        name: "Travel & pocket games",
                        href: "Entertainment/Games & puzzles/Travel & pocket games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "90bd88eb-e0c1-4276-a747-6171c88f6c72",
                        name: "Stacking & balancing games",
                        href: "Entertainment/Games & puzzles/Stacking & balancing games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "3d6edad0-59d3-4676-9b41-dbce34d1b2da",
                        name: "Board games",
                        href: "Entertainment/Games & puzzles/Board games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "8e6cbe91-687b-497d-8035-c3872eb309d9",
                        name: "Card games",
                        href: "Entertainment/Games & puzzles/Card games".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "929c53a0-c44b-4bcd-b9e4-c342aa253272",
                        name: "Brain teasers & puzzles",
                        href: "Entertainment/Games & puzzles/Brain teasers & puzzles".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "ffefdcd9-7597-41d6-84e9-d02ebaa7158f",
                        name: "Tabletop & miniature gaming",
                        href: "Entertainment/Games & puzzles/Tabletop & miniature gaming".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "9c0a944b-1f6d-41ef-a0ab-11a2e961b7c7",
                        name: "Floor games",
                        href: "Entertainment/Games & puzzles/Floor games".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Entertainment/Music & video/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "1db0d978-a9af-45db-a2c3-c31d0a392085",
                        name: "Video",
                        href: "Entertainment/Music & video/Video".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "3821e53d-73a4-4da4-98fe-e3a56441af02",
                        name: "Music",
                        href: "Entertainment/Music & video/Music".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            },
            {
                ...
                sections: [
                    {
                        ...
                        name: "All",
                        href: "Entertainment/Books/All".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "6396cc6c-abe0-4bf7-8808-08349c633b84",
                        name: "Non-fiction",
                        href: "Entertainment/Books/Non-fiction".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "fe2c027e-5114-4ada-9909-9ec43d8e956a",
                        name: "Literature & fiction",
                        href: "Entertainment/Books/Literature & fiction".split(' ').join('-').trim().toLowerCase()
                    },
                    {
                        id: "c65bd6d9-3668-400c-a95b-879ec5cee5d4",
                        name: "Kids & young adults",
                        href: "Entertainment/Books/Kids & young adults".split(' ').join('-').trim().toLowerCase()
                    }
                ]
            }
        ]
